...
public record KisFhpst01740000MarketCapResponse(
    ...
    public record Output(
            ...
            @JsonProperty("stck_avls") String stckAvls, // 시가 총액
            @JsonProperty("mrkt_whol_avls_rlim") String mrktWholAvlsRlim // 시장 전체 시가총액 비중
    ) {
    }
}
