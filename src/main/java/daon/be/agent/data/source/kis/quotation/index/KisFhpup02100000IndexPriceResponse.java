...
public record KisFhpup02100000IndexPriceResponse(
    ...
    public record Output(
            ...
            @JsonProperty("prdy_nmix_vrss_nmix_oprc") String prdyNmixVrssNmixOprc, // 전일 지수 대비 지수 시가2
            @JsonProperty("oprc_vrss_prpr_sign") String oprcVrssPrprSign, // 시가2 대비 현재가 부호
            @JsonProperty("bstp_nmix_oprc_prdy_ctrt") String bstpNmixOprcPrdyCtrt, // 업종 지수 시가2 전일 대비율
            @JsonProperty("bstp_nmix_hgpr") String bstpNmixHgpr, // 업종 지수 최고가
            @JsonProperty("prdy_nmix_vrss_nmix_hgpr") String prdyNmixVrssNmixHgpr, // 전일 지수 대비 지수 최고가
            @JsonProperty("hgpr_vrss_prpr_sign") String hgprVrssPrprSign, // 최고가 대비 현재가 부호
            @JsonProperty("bstp_nmix_hgpr_prdy_ctrt") String bstpNmixHgprPrdyCtrt, // 업종 지수 최고가 전일 대비율
            @JsonProperty("bstp_nmix_lwpr") String bstpNmixLwpr, // 업종 지수 최저가
            @JsonProperty("prdy_clpr_vrss_lwpr") String prdyClprVrssLwpr, // 전일 종가 대비 최저가
            @JsonProperty("lwpr_vrss_prpr_sign") String lwprVrssPrprSign, // 최저가 대비 현재가 부호
            @JsonProperty("prdy_clpr_vrss_lwpr_rate") String prdyClprVrssLwprRate, // 전일 종가 대비 최저가 비율
            ...
            @JsonProperty("seln_rsqn_rate") String selnRsqnRate, // 매도 잔량 비율
            @JsonProperty("shnu_rsqn_rate") String shnuRsqnRate, // 매수2 잔량 비율
            @JsonProperty("ntby_rsqn") String ntbyRsqn // 순매수 잔량
    ) {
    }
}
