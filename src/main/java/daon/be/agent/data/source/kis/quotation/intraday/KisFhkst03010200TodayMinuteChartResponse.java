...
public record KisFhkst03010200TodayMinuteChartResponse(
    ...
    public record Output1(
            ...
            @JsonProperty("stck_prdy_clpr") String stckPrdyClpr, // 전일대비 종가
            @JsonProperty("acml_vol") String acmlVol, // 누적 거래량
            @JsonProperty("acml_tr_pbmn") String acmlTrPbmn, // 누적 거래대금
    ...
    public record Output2(
            @JsonProperty("stck_bsop_date") String stckBsopDate, // 주식 영업일자
            @JsonProperty("stck_cntg_hour") String stckCntgHour, // 주식 체결시간
            @JsonProperty("stck_prpr") String stckPrpr, // 주식 현재가
            @JsonProperty("stck_oprc") String stckOprc, // 주식 시가
