...
public record KisFhkst190900C0BulkTransNumResponse(
    ...
    public record Output(
            ...
            @JsonProperty("shnu_cntg_csnu") String shnuCntgCsnu, // 매수2 체결 건수
            @JsonProperty("seln_cntg_csnu") String selnCntgCsnu, // 매도 체결 건수
            @JsonProperty("ntby_cnqn") String ntbyCnqn // 순매수 체결량
    ) {
    }
}
